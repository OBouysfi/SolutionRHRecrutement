...
class PortalClientJobOffreExport implements FromCollection, WithHeadings, WithStyles, WithTitle
{
    /**
    ...
    public function collection()
    {
        ...
        // S'assurer qu'un client est bien trouvé
        if (!$client) {
            return collect(); // retourne une collection vide si aucun client
        }
