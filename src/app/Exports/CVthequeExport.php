...
class CVthequeExport implements FromCollection, WithHeadings, WithStyles, WithTitle
{
    /**
...
{
    return Profile::with(['formations.diploma', 'formations.option', 'profession'])
        ->get()
