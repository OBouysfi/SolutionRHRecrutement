        ...
        <div class="modal-content">
            <div class="modal-body d-block">
                <form id="update-event-form">
                    @csrf
                    <input type="text" id="edit_event_id" name="id" hidden>
                            ...
                            <div
                                ...
                                <div class="input-group input-group-lg">
                                    <div class="form-floating">
                                        <input  type="text" name="title" class="form-control border-start-0" id="edit_title"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3 position-relative check-valid is-valid">
                                ...
                                <div class="custom-multiple-select rounded border poste-chosen"
                                    ...
                                    <select class="chosenoptgroup w-100" id="edit_client_id" name="client_id">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3 position-relative check-valid is-valid">
                                <div class="custom-multiple-select rounded border poste-chosen"
                                    ...
                                    <select class="chosenoptgroup w-100" id="edit_job_offer_id" name="job_offer_id">
                    ...
                    <div class="row mb-2">
                        <div class="col-3 text-center">
                            <input type="radio" name="event_type" id="edit_event_presentiel" value="presentiel"
                                onfocus="setFocus(true)" onblur="setFocus(false)" class="d-none">
                            <label for="event_pres" class="btn action-check w-100">
                                <i class="bi bi-geo-alt"></i> {{ __("generated.Présentiel")}}
                            </label>
                        </div>
                        <div class="col-3 text-center">
                            <input type="radio" name="event_type" id="edit_event_telephonique" value="telephonique"
                                onfocus="setFocus(true)" onblur="setFocus(false)" class="d-none">
                        ...
                        <div class="col-3 text-center">
                            <input type="radio" name="event_type" id="edit_event_visioconference"
                    ...
                    <div class="row mb-2 justify-content-center">
                        <div class="col-3">
                            <div class="input-box">
                                ...
                                <input type="date" class="input-1" name="date" id="edit_date"
                                    onfocus="setFocus(true)" onblur="setFocus(false)" />
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="input-box">
                                ...
                                <input type="time" class="input-1" min="00:00" max="23:59" name="start_time"
                                    onfocus="setFocus(true)" onblur="setFocus(false)" id="edit_start_time" />
                            </div>
                        </div>
                        ...
                        <div class="col-auto">
                            <div class="input-box">
                                ...
                                <input type="time" class="input-1" min="00:00" max="23:59" name="end_time"
                                    onfocus="setFocus(true)" onblur="setFocus(false)" id="edit_end_time" />
                            </div>
                        </div>
                        <div class="col-auto" style="padding-top: 25px;">
                    ...
                    <div class="row align-items-center mb-0 location-part">
                        <div class="col-12">
                            ...
                            <div
                                ...
                                <div class="input-group input-group-lg">
                                    <div class="form-floating">
                                        <input  type="text" class="form-control border-start-0" id="edit_location"
                                            onfocus="setFocus(true)" onblur="setFocus(false)" >
                        ...
                        <div class="col-12">
                            ...
                            <div class="custom-multiple-select rounded border poste-chosen pt-2"
                                ...
                                <select name="destinataires[]" class="chosenoptgroup w-100 input-1 select2"
                                    data-placeholder="Sélectionnez certaines options" onfocus="setFocus(true)"
                                    onblur="setFocus(false)" id="edit_destinataires" multiple>
                        ...
                        <div class="col-12">
                            ...
                            <div class="custom-multiple-select rounded border poste-chosen pt-2"
                                ...
                                <select name="participants[]" class="chosenoptgroup w-100 input-1 select2"
                                    data-placeholder="Sélectionnez certaines options" onfocus="setFocus(true)"
                                    onblur="setFocus(false)" id="edit_participants" multiple>
                                    @foreach ($members as $member)
                                        <option value="{{ __($member['id']) }}" data-type="{{ __($member['type']) }}">
                                            {{ __($member['email']) }}
                                        </option>
                    ...
                    <input type="hidden" id="edit_participants_meta" name="participants_meta">
                    <input type="hidden" id="edit_destinataires_meta" name="destinataires_meta">
                    ...
                    <div class="row mb-2 align-items-center mb-0 visio-part">
                                ...
                                <div class="col-auto ms-auto">
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li><a class="dropdown-item meet-action" href="javascript:void(0)"
                                                    id="Google-url">{{ __("generated.Google Meet")}}</a></li>
                                            <li><a class="dropdown-item meet-action" href="javascript:void(0)"
                                                    id="Teams-url">{{ __("generated.Microsoft Teams")}}</a></li>
                                            <li><a class="dropdown-item meet-action" href="javascript:void(0)"
                        ...
                        <div class="col-auto to-change-meet" style="width: 44.5%;">
                            ...
                            <div
                                ...
                                <div class="input-group input-group-lg">
                                    <div class="form-floating">
                                        <input  type="url" name="event_url" class="form-control border-start-0" id="edit_url"
                                            onfocus="setFocus(true)" onblur="setFocus(false)" >
                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col-sm-6">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="edit_high_importance"
                                    name="importance">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-2 position-relative check-valid is-valid rappel">
                                ...
                                <div class="custom-multiple-select rounded border poste-chosen"
                                    ...
                                    <div class="input-box">
                                        <select name="reminder" class="input-1" id="edit_reminder" onfocus="setFocus(true)"
                    ...
                    <div class="col-auto  w-100">
                        ...
                        <div class="form-group mb-3 position-relative is-valid check-valid">
                            <div class="form-floating mt-2">
                                <textarea placeholder="Description" class="form-control border-start-0 h-auto w-100 description edit_description" name="description" rows="6" id="edit_description" 
                            ...
                            <div class="card border-0">
                                <div class="card-body lettre-1" >
                                    ...
                                    <div class="file-upload">
                                        <input type="file" id="file-input-attachments" name="attachments[]"
                                            multiple class="doc-file-input profileCvInput" accept=".pdf,.doc,.docx"
                                            onfocus="setFocus(true)" onblur="setFocus(false)">
