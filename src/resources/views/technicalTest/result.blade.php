...
@section('title', 'Résultats des tests téchniques')

@section('css_header')
    <style>
        #allTestResultTable td,
        #allTestResultTable th {
            text-align: center;
    ...
    <main class="main mainheight">
        <div class="container-fluid">
            <div class="row align-items-center page-title">
                ...
                <div class="col col-sm-auto translated_text" style="margin-right: -14px;" data-bs-toggle="tooltip"
                    ...
                    <figure class="avatar avatar-40 coverimg  shadow custom-chatbox"
                        ...
                        <img src="{{ __('assets/img/icon/HJ_icon_green_black.png') }}" alt="" style="display: none;">
                    </figure>
                </div>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-theme">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active " aria-current="page">{{ __("generated.Résultats des test téchniques") }}</li>
                </ol>
            </nav>
        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card border-0">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <table class="table " data-show-toggle="true" id="allTestResultTable">
                                                            <thead style="font-size: 13px;border-top: 1px solid #e9e9e9;">
                                                                <tr style="vertical-align: middle;">
                                                                    <th style="font-weight: 600;text-align: left;width: 328px;"
                                                                        class=" text-center">{{ __("generated.Test") }}</th>
                                                                    <th style="font-weight: 600;text-align: left;width: 130px;"
                                                                        class=" text-center">{{ __("generated.Langue") }}</th>
                                                                    <th style="font-weight: 600;width: 134px;"
                                                                        class=" text-center">{{ __("generated.Statut") }}</th>
                                                                    <th style="font-weight: 600;width: 183px;"
                                                                        class=" text-center">{{ __("generated.Date de passage") }}</th>
                                                                    <th style="font-weight: 600;width: 120px;"
                                                                        class=" text-center">{{ __("generated.Résultat") }}</th>
                                                                    <th style="font-weight: 600;text-align: right;width: 71px;"
                                ...
                                <li class="list-group-item text-secondary"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 ps-0">
                                            <span >{{ __("generated.Permettre au candidat de répondre") }}</span>
                                            &nbsp;<strong >{{ __("generated.Je ne sais pas") }}</strong>
                                        </div>
                                    </div>
                                </li>
                                <li class="list-group-item text-secondary"
                                    ...
                                    <div class="input-group input-group-lg">
                                        <div class="form-floating">
                                            <select class="form-select border-0" id="country1" required="">
                                                ...
                                                <option>Farida EL WAFA</option>
                                                <option>Omar BENKIRANE</option>
                                                <option>Jaouad FATHALLAH</option>
                                            </select>
                                    ...
                                    <div class="input-group input-group-lg">
                                        <div class="form-floating">
                                            <select class="form-select border-0" id="country1" required="">
                                                ...
                                                <option value="3" >{{ __("generated.Tous les 3 jours") }}</option>
                                    ...
                                    <div class="form-group mb-3 position-relative is-valid check-valid">
                                        <div class="form-floating">
                                            <textarea style="padding-top: 11px;color: #0000008f !important;" placeholder=""
                                                class="form-control border-start-0 h-auto translated_text " rows="4">{{ __("generated.Entrez un intitulé ou une description de poste, plus la description est précise, plus la recommandation sera pertinente.") }}</textarea>
                ...
                <div class="modal-body d-block">
                    ...
                    <div class="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="ltr"
                        lang="en" aria-labelledby="ck-editor__label_e889a9a16225ce53ddb0fa9c6ac9a28ad"><label
                            ...
                            id="ck-editor__label_e889a9a16225ce53ddb0fa9c6ac9a28ad">{{ __("generated.Rich Text Editor") }}</label>
                                            ...
                                            <div class="ck ck-dropdown ck-heading-dropdown"><button
                                                        ...
                                                        <li class="ck ck-list__item"><button
                                                                ...
                                                                aria-labelledby="ck-editor__aria-label_e85cc2fb791f304f1404e3a66c0b0797a"><span
                                                                    class="ck ck-tooltip ck-tooltip_s ck-hidden"><span
                                                                        class="ck ck-tooltip__text"></span></span><span
                                                                    class="ck ck-button__label"
                                                                    id="ck-editor__aria-label_e85cc2fb791f304f1404e3a66c0b0797a"><span
                                                                        >{{ __("generated.Heading") }}</span>
                                                                    1</span></button></li>
                                                        <li class="ck ck-list__item"><button
                                                                ...
                                                                aria-labelledby="ck-editor__aria-label_e2fdca9896a3d870a3f0ccf9c1f3fe019"><span
                                                                    class="ck ck-tooltip ck-tooltip_s ck-hidden"><span
                                                                        class="ck ck-tooltip__text"></span></span><span
                                                                    class="ck ck-button__label"
                                                                    id="ck-editor__aria-label_e2fdca9896a3d870a3f0ccf9c1f3fe019"><span
                                                                        >{{ __("generated.Heading") }}</span>
                                                                    2</span></button></li>
                                                        <li class="ck ck-list__item"><button
                                                                ...
                                                                aria-labelledby="ck-editor__aria-label_e6fcd885e0bfc205091a143c6fa1c02eb"><span
                                                                    class="ck ck-tooltip ck-tooltip_s ck-hidden"><span
                                                                        class="ck ck-tooltip__text"></span></span><span
                                                                    class="ck ck-button__label"
                                                                    id="ck-editor__aria-label_e6fcd885e0bfc205091a143c6fa1c02eb"><span
                                                                        >{{ __("generated.Heading") }}</span>
                                                                    3</span></button></li>
                                                    </ul>
                                                </div>
                                                ...
                                                aria-pressed="false"><svg class="ck ck-icon ck-button__icon"
                                                    ...
                                                    <path
                                                        ...
                                                        class="ck ck-tooltip__text ">{{ __("generated.Bold (Ctrl+B)") }}</span></span><span
                                                    class="ck ck-button__label "
                                                    id="ck-editor__aria-label_e0bb186f4744098d5ce2775c67de42f2d">{{ __("generated.Bold") }}</span></button><button
                                                class="ck ck-button ck-off" type="button" tabindex="-1"
                                                ...
                                                aria-pressed="false"><svg class="ck ck-icon ck-button__icon"
                                                    ...
                                                    <path
                                                        ...
                                                        class="ck ck-tooltip__text ">{{ __("generated.Italic (Ctrl+I)") }}</span></span><span
                                                    class="ck ck-button__label "
                                                    id="ck-editor__aria-label_ec206dbb0f021437acffb0f2d70f716ef">{{ __("generated.Italic") }}</span></button><button
                                                class="ck ck-button ck-off" type="button" tabindex="-1"
                                                ...
                                                aria-pressed="false"><svg class="ck ck-icon ck-button__icon"
                                                    ...
                                                    <path
                                                        ...
                                                        class="ck ck-tooltip__text ">{{ __("generated.Link (Ctrl+K)") }}</span></span><span
                                                    class="ck ck-button__label "
                                                    id="ck-editor__aria-label_ea2b6566baa0566d7b919f5601dfe6eb9">{{ __("generated.Link") }}</span></button><button
                                                class="ck ck-button ck-off" type="button" tabindex="-1"
                                                ...
                                                <div class="ck ck-toolbar" role="toolbar" aria-label="Dropdown toolbar">
                                                    <div class="ck ck-toolbar__items"><span
                                                        ...
                                                        <div class="ck ck-dropdown"><button
                                                            ...
                                                            <div
                                                                class="ck ck-reset ck-dropdown__panel ck-dropdown__panel_se">
                                                                <form class="ck ck-media-form ck-responsive-form"
                                                                    tabindex="-1">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                id="ck-editor__label_e9c741bec93e7bd2f0259fb4299f7a7a1"
                                                        ...
                                                        </div><button class="ck ck-button ck-disabled ck-off"
                                                            type="button" tabindex="-1"
                    ...
                    <div class="row">
                        <div class="col-12 ms-auto">
                            <div class="form-check form-switch" style="margin-right: -15px">
                                ...
                                <button data-bs-toggle="modal" data-bs-target="#emailcompose"
                                    class="btn btn-theme mnw-100 bg-green "
                                    style="float: right;font-size: 14px;margin-left: 10px;">{{ __("generated.Envoyer") }}</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 mb-2">
                            <div class="form-group mb-3 position-relative check-valid is-valid">
                                ...
                                <div class="input-group input-group-lg">
                                    <div class="form-floating">
                                        <input type="text" placeholder="{{ __("generated.Mot de passe") }}" value="" required=""
                        ...
                        <div class="col-12 col-md-12 mb-2">
                            <div class="form-group mb-3 position-relative check-valid is-valid">
                                ...
                                <div class="input-group input-group-lg">
                                    <div class="form-floating">
                                        <input type="text" placeholder="{{ __("generated.Confirmer le mot de passe") }}" value=""
                    ...
                    <div class="row">
                        <div class="col-12 ms-auto">
                            <div class="form-check form-switch" style="margin-right: -15px">
                                ...
                                <button data-bs-toggle="modal" data-bs-target="#emailcompose"
                                    class="btn btn-theme mnw-100 bg-green "
                                    style="float: right;font-size: 14px;margin-left: 10px;">{{ __("generated.Valider") }}</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 mb-2 mt-2">
                            <button class="btn btn-theme modal-btn btn-modal1 "
                                style="font-size: 14px;padding: 10px 29px;background-color: transparent;border: 1px solid #005dc7;color: #005dc7;width: 100%">{{ __("generated.Désactiver le test") }}</button>
                        </div>
                        <div class="col-6 mb-2 mt-2" style="width: 48%">
                            <button class="btn btn-theme modal-btn btn-modal2 "
                                style="font-size: 14px;padding: 10px 29px;background-color: transparent;border: 1px solid #005dc7;color: #005dc7;width: 100%">{{ __("generated.Relancer le test") }}</button>
                        </div>
                    </div>
                </div>
                <div class="modal-footer" style="background-color: #d2e3f6;padding: 16px;border: 0">
...
@section('js_footer')
    ...
    <script>
        ...
        var ApiListingTestsResults = "{{ route('api.testsTechniques.listing.all.results') }}"
    ...
    @vite(['resources/js/technicalTest/result-tests.js'])
