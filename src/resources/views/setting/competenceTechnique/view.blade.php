    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title " id="techModalLabel">{{ __("generated.Détails Compétence Technique") }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <p id="view_skill_type_id" class="form-control-plaintext d-inline mb-0 text-bw"></p>
                    </div>
                </div>
            </div>
