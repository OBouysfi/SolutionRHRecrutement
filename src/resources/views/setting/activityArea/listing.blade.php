...
@section('title', __("generated.HumanJobs - Liste des secteurs d’activité"))
...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row align-items-center page-title">
                <div class="col-12 col-md mb-3 mb-sm-0">
                    <h5 class="mb-0 ">{{ __("generated.Secteurs d'activité") }}</h5>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-theme">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">{{ __("generated.Liste des secteurs d'activité") }}</li>
                </ol>
            </nav>
        </div>
                                        ...
                                        <div class="card-body bg-gradient-theme-light">
                                            <div class="row justify-content-center align-items-center">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <h5 >{{ __("generated.Liste des secteurs d'activité") }}</h5>
                                                </div>
                                                <!-- Boutons et actions -->
                                                <div class="col-12 col-md-8 d-flex justify-content-end">
                                                    <div class="d-flex flex-wrap gap-2">
                                                        ...
                                                        <div class="col-auto translated_text" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="{{ __("generated.Ajouter un secteur d’activité") }}">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="card-header bg-gradient-theme-light ">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <h5 >{{ __("generated.Secteurs d'activité") }}</h5>
                                                </div>
                                                <div class="col-12 col-md-3 mt-2 mt-md-0 ms-auto">
                                                    <div class="input-group searchbar-full">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="customSearchBox" placeholder="{{ __("generated.Search...") }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive" style="padding:6px">
                                            <table class="table table-striped w-100 align-middle" id="activityAreasTable"
                                             style="width:100%; border-top: 1px solid #e9e9e9  !important;">
                                                <thead>
                                                    <tr>
                                                        <th class="fw-bold ">{{ __("generated.Secteur d'activité") }}</th>
    ...
    @include('setting.activityArea.inc.create')
    @include('setting.activityArea.inc.view')
    @include('setting.activityArea.inc.edit')
...
@section('js_footer')
    <script>
        var activityAreaData = "{{ route('api.activityarea.listing') }}";

        var activityAreaStore = "{{ route('api.activityarea.store') }}";

        var editActivityUrl = "{{ url('/setting/activity_areas') }}";
        // var updateActivityUrl = "{{ url('/api/setting/activity-areas') }}";
    </script>
    <script>
        var exportUrl = '{{ route('activityArea.export') }}';
    ...
    @vite(['resources/js/activityArea/listing.js', 'resources/js/activityArea/view.js', 'resources/js/activityArea/create.js', 'resources/js/activityArea/edit.js'])
