    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title " id="exampleModalLabel">{{ __("generated.Ajouter un secteur d'activité") }}</h5>
                <button type="button" class="btn-close translated_text" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="" method="POST" id="activityareaform">
                    @csrf
                    <div class="form-group mb-3 position-relative is-valid check-valid">
                        <div class="form-floating">
                            <input type="text" placeholder="{{ __("generated.Nom du secteur") }}" name="label" id="labelInput"
            ...
            <div class="modal-footer">
                <input type="submit" class="btn btn-theme "  style="font-size: 18px; padding: 5px 9px; border-radius: 5px;"  id="save" value="{{ __("generated.Ajouter") }}"></button> 
            </form>
            </div>
        </div>
    </div>
