...
@section('title', __('generated.HumanJobs - Liste des Compétences Personnelles'))
...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row align-items-center page-title">
                <div class="col-12 col-md mb-2 mb-sm-0">
                    <h5 class="mb-0 ">{{ __("generated.Compétences Personnelles") }}</h5>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-theme">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">{{ __("generated.Liste des Compétences Personnelles") }}</li>
                </ol>
            </nav>
        </div>
                                        ...
                                        <div class="card-body bg-gradient-theme-light">
                                            <div class="row justify-content-center align-items-center">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <h5 >{{ __("generated.Liste des Compétences Personnelles") }}</h5>
                                                </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="card-header bg-gradient-theme-light ">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <h5 >{{ __("generated.Compétences Personnelles") }}</h5>
                                                    </div>
                                                    <div class="col-12 col-md-3 mt-2 mt-md-0 ms-auto">
                                                        <div class="input-group searchbar-full">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" id="customSearchBox-personnelle" placeholder="{{ __("generated.Search...") }}">
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center mx-0 mb-3">
                                            ...
                                            <div class="col-6 footable-paging-external footable-paging-right footable-pagination"
                                                id="validated-personnellesTable-pagination">
    ...
    @include('setting.competencePersonnelle.create')
    @include('setting.competencePersonnelle.view')
    @include('setting.competencePersonnelle.edit')
...
@section('js_footer')
    <script>
        var exportUrl = '{{ route('personnelle.export') }}';
    ...
    <script>
        var compPersonnelleData = "{{ route('api.personnelle.listing') }}";
        var persoView = "{{ route('api.personnelle.view', ['id' => '__ID__']) }}";
        var persoDestroy = "{{ route('api.personnelle.destroy', ['perso' => '__ID__']) }}";
        var persoUpdateUrl = "{{ route('api.personnelle.update', ['perso' => '__ID__']) }}";
    </script>

    @vite(['resources/js/competencePersonnelle/listing.js', 'resources/js/competencePersonnelle/create.js',])
@endsection
