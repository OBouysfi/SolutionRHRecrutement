...
@section('title', __('generated.HumanJobs - Liste des dossier de talents')) 
...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row align-items-center page-title">
                <div class="col-12 col-md mb-2 mb-sm-0">
                    <h5 class="mb-0 ">{{ __("generated.dossier de talents") }}</h5>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-theme">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">{{ __("generated.Liste des dossier de talents") }}</li>
                </ol>
            </nav>
        </div>
                                        ...
                                        <div class="card-body bg-gradient-theme-light">
                                            <div class="row justify-content-center align-items-center">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <h5 >{{ __("generated.Liste de dossiers de talents") }}</h5>
                                                </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="card-header bg-gradient-theme-light ">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <h5 >{{ __("generated.Dossier de talents") }}</h5>
                                                </div>
                                                <div class="col-12 col-md-3 mt-2 mt-md-0 ms-auto">
                                                    <div class="input-group searchbar-full">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="customSearchBox-folder" placeholder="{{ __("generated.Search...") }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive" style="padding:6px">
                                            <table class="table table-striped w-100 align-middle" id="foldersTable"
                                              style="width:100%; border-top: 1px solid #e9e9e9  !important;">
                                                <thead style="font-size: 13px;border-top: 1px solid #e9e9e9;">
                                                    <tr>
                                                        <th style="font-weight: 600;" >{{ __("generated.Dossier de talent") }}</th>
                                                        <th style="font-weight: 600;" >{{ __("generated.Parent") }}</th>
    ...
    @include('setting.talentFolders.create')
    @include('setting.talentFolders.view')
    @include('setting.talentFolders.edit')
    @include('profile.inc.translation')
@endsection

@section('js_footer')
    <script>
        var exportUrl = '{{ route('profile-folders.export') }}';
    ...
    <script>
        var foldersData = "{{ route('api.profile-folders.listing') }}";
        var folderView = "{{ route('api.profile-folders.view', ['id' => '__ID__']) }}";
        var folderDestroy = "{{ route('api.profile-folders.destroy', ['folder' => '__ID__']) }}";
        var folderUpdateUrl = "{{ route('api.profile-folders.update', ['folder' => '__ID__']) }}";
    </script>

    @vite(['resources/js/profileFolders/listing.js', 'resources/js/profileFolders/create.js',])
