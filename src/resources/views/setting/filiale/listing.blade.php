...
@section('title', 'HumanJobs - Liste des Filiales')
...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row align-items-center page-title">
                <div class="col-12 col-md mb-3 mb-sm-0">
                    <h5 class="mb-0" >{{ __("generated.Filiale") }}</h5>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-theme">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active " aria-current="page">{{ __("generated.Liste des Filiales") }}</li>
                </ol>
            </nav>
        </div>
                                        ...
                                        <div class="card-body bg-gradient-theme-light">
                                            <div class="row justify-content-center align-items-center">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <h5 >{{ __("generated.Liste des Filiales") }}</h5>
                                                </div>
                            ...
                            <div class="card border-0 p-3 p-md-4">
                                <div class="card-body p-0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped w-100" id="filialesTable">
                                            <thead>
                                                <tr>
                                    ...
                                    <div class="row align-items-center mx-0 mb-3">
                                        ...
                                        <div class="col-6 footable-paging-external footable-paging-right footable-pagination"
                                            id="validated-filialesTable-pagination">
    ...
    @include('setting.filiale.create')
    @include('setting.filiale.view')
    @include('setting.filiale.edit')
...
@section('js_footer')
    ...
    <script>
        var filialeData = "{{ route('api.filiale.listing') }}";
        var filialestore = "{{ route('api.filiale.store') }}";
        var filialesView = "{{ route('api.filiale.view', ['id' => '__ID__']) }}";
        var filialesDestroy = "{{ route('api.filiale.destroy', ['filiale' => '__ID__']) }}";
        var filialesUpdateUrl = "{{ url('/api/filiales/update/__ID__') }}";
    </script>

    <script>
        var exportUrl = '{{ route('filiale.export') }}';
    ...
    @vite(['resources/js/filiale/listing.js', 'resources/js/filiale/create.js', 'public/assets/css/custom-style.css'])
