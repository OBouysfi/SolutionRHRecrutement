...
function waitForDependencies() {
    ...
    const checkDependencies = () => {
        ...
        if (tryConfigureAxios() && typeof window.Echo !== 'undefined' && typeof window.Pusher !== 'undefined') {
            Logger.info('All dependencies loaded successfully');
            setupEcho();
        } else if (attempts < maxAttempts) {
            setTimeout(checkDependencies, 100);
        } else {
            Logger.error('Failed to load dependencies after maximum attempts');
...
// Enhanced Echo setup with better error handling
function setupEcho() {
    ...
    try {
        ...
        // Create private channel using the instance
        ...
        // Listen for connection events using the instance
        ...
        Logger.info('Echo listeners setup successfully');
...
function handleIncomingCall(fromUserId, offer, fromUserName = null) {
    try {
        ...
        if (currentCallWith) {
            ...
            // Could implement call waiting here
