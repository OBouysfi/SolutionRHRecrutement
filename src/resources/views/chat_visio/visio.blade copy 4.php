...
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/axios/1.11.0/axios.min.js" integrity="sha512-h9644v03pHqrIHThkvXhB2PJ8zf5E9IyVnSfZg8Yj8k4RsO4zldcQc4Bi9iVLUCCsqNY0b4WXVV4UB+wbWENA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script> -->
<script>
...
function setupEcho() {
    try {
        Logger.info('Setting up Pusher listeners...');

        const pusherKey = process.env.MIX_PUSHER_APP_KEY || 'local';
        const userId = window.Laravel?.user?.id || null; // Use your own way to get the auth ID
        ...
        channel.bind('pusher:subscription_succeeded', () => {
            Logger.info('Pusher subscription succeeded');
        ...
        channel.bind('pusher:subscription_error', (status) => {
            ...
            NotificationManager.show('Subscription error', 'error');
        });

        // Custom event handlers
        channel.bind('App\\Events\\WebRTCOffer', (e) => {
        ...
        channel.bind('App\\Events\\WebRTCAnswer', (e) => {
        ...
        channel.bind('App\\Events\\ICECandidate', (e) => {
        ...
        channel.bind('App\\Events\\CallEnded', (e) => {
        ...
        Logger.info('Pusher listeners setup successfully');
