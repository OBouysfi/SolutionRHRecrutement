...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" integrity="sha512-Avb2QiuDEEvB4bZJYdft2mNjVShBftLdPG8FJ0V7irTLQ8Uo0qcPxh4Plq7G5tGm0rU+1SPhVotteLpBERwTkw==" crossorigin="anonymous" referrerpolicy="no-referrer" />@vite(['resources/js/app.js'])
...
function setupEcho() {
    try {
        Logger.info('Setting up Echo listeners...');
        
        if (!window.Echo) {
            throw new Error('Echo is not available');
        }

        const channelName = `video-call.{{ auth()->id() }}`;
