                                            ...
                                            <div class="row justify-content-center mt-3">
                                                ...
                                                <div class="col-2" style="width: 12%;">
                                                    <div class="col-auto position-relative">
                                                        ...
                                                        <div class="position-absolute hidden bottom-0 end-0 z-index-1 me-3 mb-1 h-auto" style="top: 78% !important;right: 10%;">
                                                                    ...
                                                                    <div class="input-group input-group-lg">
                                                                        ...
                                                                        <div class="form-floating">
                                                                            <input type="text" name="id"
                                                                                placeholder="Numéro"
                                                                                value="{{ isset($client) ? $client->id : null }}"
                                                                                required=""
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="input-group input-group-lg">
                                                                        <div
                                                                            ...
                                                                            <select disabled
                                                                                class=" custom-multiple-select form-select border-0"
                                                                                name="juridical_form">
                                                                                <option value=""
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="input-group input-group-lg">
                                                                        <div
                                                                            ...
                                                                            <select disabled class="form-select border-0"
                                                                                name="tax_regime">
                                                                                <option value="">Tous</option>
                                                                                @foreach ($taxRegimes as $key => $taxRegime)
                                                                                <option
                                                                                    value="{{ $key }}"
                                                                                    {{ isset($client) && $client->tax_regime == $taxRegime ? 'selected' : '' }}>
                                                                                    {{ __($taxRegime) }}
                                                                                </option>
                                                                                @endforeach
                                                                            </select>
                                                        ...
                                                        <div class="col-12 col-md-12">
                                                            <div>
                                                                <div
                                                                    ...
                                                                    <div class="input-group input-group-lg">
                                                                        <div class="form-floating">
                                                                            <input disabled name="adresse" type="text"
                                                                                placeholder="Adresse"
