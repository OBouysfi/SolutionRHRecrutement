    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-body p-4">
                <h6 class="mb-4 text-center"><span class="translated_text">{{ __("generated.Envoyez un lien de cette page par email.") }}</span></h6>
                <form action="{{ route('send.share.email') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-secondary"><span class="translated_text">{{ __("generated.À :") }}</span></label>
                        <input type="text" name="to" class="form-control"
                            placeholder="{{ __("generated.Entrez les adresses email") }}" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label text-secondary"><span class="translated_text">{{ __("generated.CC :") }}</span></label>
                        <input type="text" name="cc" class="form-control"
                            placeholder="{{ __("generated.Entrez les adresses en CC") }}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label text-secondary"><span class="translated_text">{{ __("generated.Objet :") }}</span></label>
