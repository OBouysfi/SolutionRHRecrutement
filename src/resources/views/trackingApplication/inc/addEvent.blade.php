...
<div class="modal fade" id="createEventModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" style="width:840px">
                ...
                <form id="store-event-form">
                    ...
                    <div class="row mb-2 justify-content-center">
                        ...
                        <div class="col-auto" style="width: 159px;">
                            <div class="input-box">
                                <label class="input-label" style="padding-top:25px; background-color: transparent;" id="eventTime" style="color: #000;font-size: 14px;">15
                                    Minutes</label>
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-12">
                            <label class="">{{ __("generated.Destinataires") }}</label>
                    ...
                    <div class="row mb-2 align-items-center mb-0">
                        <div class="col-12">
                            <label class="">{{ __("generated.Participants") }}</label>
                            <div class="custom-multiple-select rounded border poste-chosen pt-2"
                                style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;">
