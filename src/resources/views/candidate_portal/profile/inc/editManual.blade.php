{{-- <div class="tab-pane fade show active" id="manuel" role="tabpanel" aria-labelledby="manuel-tab"> --}}
        ...
        <div class="tab-content py-3 bg-light-theme-only" id="mySubTabContent">
            <div class="card border-0 mb-3 bg-none shadow-none">
                <div class="card border-0 mb-3 bg-none shadow-none">
                    ...
                    <figure class="cover-figure coverimg w-100 h-300 mb-0 position-relative rounded"
                        style="background-image: url('{{ isset($profile) ? $profile->getCoverUrl() : asset('assets/img/icon/photo-empty.png') }}');">
                        <div class="position-absolute top-0 end-0 m-3">
                            <label class="btn btn-light">
                                <i class="bi bi-camera"></i> {{ __('generated.Modifier la couverture') }}
                    ...
                    <div class="row align-items-start justify-content-center mb-3">
                        <div class="col-auto position-relative">
                            <figure
                                ...
                                style="background-size: cover; background-image: url('{{ $profile->getAvatarUrl() }}');">
                        ...
                        <div class="row align-items-start justify-content-center mt-4 civillity-section"
                            ...
                            <div class="col-auto">
                                <div class="form-check form-check-circle">
                                    <input class="form-check-input priceupgrade1" type="radio" name="civility_manual"
                            ...
                            <div class="col-auto">
                                <div class="form-check form-check-circle">
                                    <input class="form-check-input priceupgrade2" type="radio" name="civility_manual"
                        ...
                        <div class="row align-items-start justify-content-center mt-4" id="name-section"
                            ...
                            <div class="col-auto">
                                <div class="form-group mb-3 position-relative is-valid check-valid">
                                    <div class="form-floating">
                                        <input type="text" placeholder="{{ __('generated.Prénom') }}" id="profileFirstName"
                            ...
                            <div class="col-auto">
                                <div class="form-group mb-3 position-relative is-valid check-valid">
                                    <div class="form-floating">
                                        <input type="text" placeholder="{{ __('generated.Nom') }}" id="profileLastName"
                                            value="@if (isset($profile) && $profile->last_name) {{ __($profile->last_name) }} @endif"
                                            required class="form-control border-start-0">
