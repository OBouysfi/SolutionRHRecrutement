<div class="card border-0" style="margin-top: 0px;margin-bottom: 19px;">
    <div class="card-header bg-gradient-theme-light">
        <div class="row align-items-center">
            {{-- <div class="col-auto">
                <i class="bi bi-person h5 me-1 avatar avatar-40 bg-light-theme rounded me-2"></i>
            </div> --}}
            <div class="col ps-0">
...
<div class="card border-0 mb-4">
    <div class="card-body">
        ...
        <div class="row justify-content-center" style="padding: 12px 30px;">
            <div id="personal-skills-list" class="col-12">
                            ...
                            <div class="row" style="padding-left: 21px;">
                                <div class="col-12 col-md-5 mb-2">
                                    <div  class="custom-multiple-select rounded border poste-chosen"
                                        ...
                                        <select disabled class="chosenoptgroup w-100 filled-personal-category personal-category"
                                            readonly>
                                ...
                                <div class="col-12 col-md-5 mb-2">
                                    <div  class="custom-multiple-select rounded border poste-chosen"
                                        ...
                                        <select disabled class="chosenoptgroup w-100 filled-personal-skill-name personal-skill"
                                            readonly>
                                ...
                                <div class="col-12 col-md-2 mb-2">
                                    <div  class="custom-multiple-select rounded border poste-chosen"
                                        ...
                                        <select disabled class="chosenoptgroup w-100 filled-personal-level personal-level"
                                            readonly>
