                                ...
                                <div class="row mb-4 justify-content-center">
                                    ...
                                    <div class="col-12 col-md-3 mb-4">
                                        <div class="custom-multiple-select rounded border poste-chosen"
                                            ...
                                            <select disabled class="chosenoptgroup w-100" name="desired_profession_id"
                                    ...
                                    <div class="col-12 col-md-3 mb-4">
                                        <div class="custom-multiple-select rounded border poste-chosen"
                                            ...
                                            <select disabled class="chosenoptgroup w-100" name="contract_type" id="contract">
                                                @if (isset($contractsTypes))
                                                    @foreach ($contractsTypes as $key => $contract)
                                                        <option value="{{ $key ?? '' }}"
                                                            @if ($profile->contract_type == $key)  @endif>
                                                            {{ $contract ?? '_' }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                    ...
                                    <div class="col-12 col-md-3 mb-4">
                                        <div class="custom-multiple-select rounded border poste-chosen"
                                            style="border-bottom: 1px solid var(--adminux-theme) !important; border-radius: 8px !important;">
                                            <label style="font-size: 12px; margin-left: 9px; display: inline;">
                                                <span >{{ __("generated.Catégorie Socio Professionnelle") }}</span><span class="text-themeColor">*</span></label>
                                            <select disabled class="chosenoptgroup w-100" id="permis"
                                    ...
                                    <div class="col-12 col-md-3 mb-4">
                                        <div class="custom-multiple-select rounded border poste-chosen"
                                            style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;">
                                            <label style="font-size: 12px; margin-left: 9px; display: inline;"><span >{{ __("generated.Taille de l'entreprise") }}</span> <span
                                                    class="text-themeColor">*</span></label>
                                            <select disabled class="chosenoptgroup w-100" id="permis" name="company_size">
                                                {{-- <option value="" class="to-hidden">Tous</option> --}}
                                    ...
                                    <div class="col-12 col-md-6 mb-4">
                                        <div class="custom-multiple-select rounded border poste-chosen"
                                            style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;">
                                            <label style="font-size: 12px; margin-left: 9px; display: inline;"><span >{{ __("generated.Secteur d'activité") }}</span> <span
                                                    class="text-themeColor">*</span></label>
                                            <select disabled class="chosenoptgroup w-100" name="activity_area_id"
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                <div class="row mt-5 justify-content-center">
                                    ...
                                    <div class="col-12 col-lg-5 mt-2 mb-2">
                                        <div class="row">
                                            <div class="col-md-auto">
                                                <div
                                                    class="form-group mb-3 position-relative check-valid is-valid" style="box-shadow: none !important">
                                                    <div class="input-group input-group-lg input-group-label"
                                                        style="padding: 10px 26px; min-width: 210px;">
                                ...
                                <div class="row mb-4 justify-content-center">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-12">
                                                <div class="custom-multiple-select rounded border poste-chosen"
                                                    ...
                                                    <select disabled class="chosenoptgroup w-100" name="has_driving_license"
                                    ...
                                    <div class="col-6 col-md-3 mt-3 license-type-container" id="has_driving_license">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group mb-3 position-relative check-valid is-valid">
                                                    <div class="input-group input-group-lg custom-multiple-select"
                                                        style="padding: 16px 15px 6px;">
                                                        <div class="form-floating">
                                                            <div class="dropdown d-inline-block" style="width: 100%;">
                                                                <a class="text-secondary dd-arrow-none"
                                                                    ...
                                                                    <label
                                                                        style="transform: scale(0.75) translateY(-0.5rem) translateX(0.15rem); position: absolute; top: -7px; left: -18px; color: #5f6165;"
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end"
                                                                    style="top: auto; left: 0; width: 100%;display: none;">
                                                                        ...
                                                                        <li class="dropdown-item">
                                                                            <label style="font-size: 12px; margin-left: 9px; display: inline;">
                                                                                <input disabled  type="checkbox"
                                                                                    ...
                                                                                    value="{{ $key }}"
                                                                                    @if (in_array($key, json_decode($profile->license_types ?? '[]', true) ?? [])) checked @endif>
                                                                                {{ ($license ?? ' ') }}
                                                        ...
                                                        {{-- @php
                                                            $selectedLicenses =
                                                                json_decode($profile->license_types ?? '[]', true) ??
                                                                [];
                                                        @endphp

                                                        <div class="form-floating"
                                                            style="width: 100%; max-width: 100%;">
                                                            <select disabled class="form-select select2" name="license_types[]"
                                                                id="license_types" multiple style="width: 100%;">
                                                                @foreach (App\Enums\DrivingLicense\TypeDrivingLicenseEnum::getAll() as $key => $license)
                                                                    <option value="{{ $key }}"
                                                            ...
                                                            <label for="license_types" style="top: -15px">Type de permis</label>
                                                        </div> --}}
                                                    </div>
                                                </div>
                                            </div>
...
<div class="row">
    <div class="col-12  mb-4">
        <a href="{{ route('candidate-portal.profile.edit') }}" onclick="saveTabAndGo('8')">
