                                            ...
                                            <div class="form-group mb-3 position-relative is-valid check-valid">
                                                <div class="input-group input-group-lg">
                                                    <div class="form-floating">
                                                        ...
                                                        <label><span >{{ __("generated.Prénom") }}</span> <span
...
<div class="row mt-3 mb-4 mt-4" style="float: right">
    <div class="col-auto">
        <!-- submit button -->
        <button class="btn btn-theme translated_text" type="button" onclick="switchToNextTab(6)">{{ __("generated.Enregister") }}</button>
    </div>
    <div class="col-auto">
          ...
          <div class="mb-3">
            ...
            <input type="email" class="form-control" name="email" required> --}}
                <div class="form-group mb-3 position-relative check-valid is-valid">
                        <div class="input-group input-group-lg">
                                <div class="form-floating">
                                    <input type="email" class="form-control border-start-0" id="folderName" name="email" required>
