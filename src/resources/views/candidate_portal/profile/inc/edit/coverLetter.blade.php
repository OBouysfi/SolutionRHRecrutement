                                ...
                                <div class="col-8" style="">
                                    <div class="row">
                                                ...
                                                <div class="input-group input-group-lg">
                                                    <div class="form-floating">
                                                        <input type="text" placeholder="Objet"
                                                            value="{{ __($coverLetter?->subject) }}" required=""
                                                            name="subject"
                                                            class="form-control border-start-0 translated_text">
                                                        <label><span >{{ __("generated.Objet") }}</span> <span
                                        ...
                                        <div class="col-12 col-md-6 col-lg-12 mt-3">
                                            <label class="mb-2"><span >{{ __("generated.Votre text") }}</span><span class="text-themeColor">*</span></label>
                                            <div class="input-group input-group-lg">
                                                <div class="form-floating">
                                                    <textarea class="form-control border" style="height: 300px;" rows="10" id="cover_letter_ckeditor"
                                                        name="description">{!! $coverLetter?->description !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col mt-4">
                                            ...
                                            <!-- <button class="btn btn-theme btn-ajouter " type="button"
                                                style="font-size: 12px;float: right;margin-left: 10px;margin-right: 10px;"
                                            ...
                                            <button
                                                ...
                                                type="button" class="btn btn-theme btn-ajouter "
                                                style="font-size: 12px; float: right; margin-left: 10px; margin-right: 10px; background-color: #26b6ea;">{{ __("generated.Modifier") }}</button>
    ...
    <div class="row mt-3 mb-4" style="float: right">
        <div class="col-auto">
            <button class="btn btn-theme " type="button"
                onclick="switchToNextTab(7)">{{ __("generated.Enregister") }}</button>
        </div>
        <div class="col-auto">
