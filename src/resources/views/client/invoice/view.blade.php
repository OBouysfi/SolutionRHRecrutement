...
<main class="main mainheight">
    ...
    <div class="container-fluid">
        <div class="row align-items-center page-title">
            ...
            <div class="col col-sm-auto" style="margin-right: -14px;" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __("generated.Chatbot") }}">
            ...
            <div class="col col-sm-auto"  data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __("generated.Confort utilisateur") }}" style="margin-right: 40px;">
                                    ...
                                    <div class="card-body filter-block">
                                        <div class="row">
                                            ...
                                            <div class="col-3" style="width: 249px;">
                                                <div class="rounded border poste-chosen" style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;background-color: var(--adminux-theme-bg) !important;">
                                                    <label style="margin-top: 8px;margin-left: 17px;color: #505050;font-size: 12px;">Client</label>
                                            ...
                                            <div class="col-3" style="width: 278px;">
                                                <div class="rounded border poste-chosen" style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;background-color: var(--adminux-theme-bg) !important;">
                                                    <label style="margin-top: 8px;margin-left: 17px;color: #505050;font-size: 12px;">Missions en cours </label>
                                                    <select class="chosenoptgroup w-100">
                                                        <option>Tous</option>
                                            ...
                                            <div class="col-3" style="width: 276px;margin-right: 0px  !important;">
                                                <div class="rounded border poste-chosen" style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;background-color: var(--adminux-theme-bg) !important;">
                                                    <label style="margin-top: 8px;margin-left: 17px;color: #505050;font-size: 12px;">Statut du client</label>
                                                    <select class="chosenoptgroup w-100">
                                                        <option>Tous</option>
                                                        <option>Actif</option>
            ...
            <div class="col-10">
                <ul class="nav nav-tabs justify-content-center nav-adminux nav-lg" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation4">
                        <button style="font-size: 14px" class="nav-link " id="personal4-tab" data-bs-toggle="tab" data-bs-target="#personal4" type="button" role="tab" aria-controls="personal4" aria-selected="true">Balance Agée</button>
                    </li>
                    <li class="nav-item" role="presentation5">
                        <button style="font-size: 14px" class="nav-link " id="personal5-tab" data-bs-toggle="tab" data-bs-target="#personal5" type="button" role="tab" aria-controls="personal5" aria-selected="true">Grand Livre</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button style="font-size: 14px" class="nav-link active" id="personal-tab" data-bs-toggle="tab" data-bs-target="#personal" type="button" role="tab" aria-controls="personal" aria-selected="true">Etat des factures</button>
                    </li>
                </ul>
            </div>
        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row justify-content-center ">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group  position-relative check-valid is-valid">
                                                                    <div class="input-group input-group-lg">
                                                                        <div class="form-floating">
                                                                            <input type="date" placeholder="" value="2024-11-30" required="" class="form-control border-start-0">
                                                            ...
                                                            <div class="col-auto" style="width: 32%">
                                                                <div class="form-group  position-relative check-valid is-valid">
                                                                    <div class="input-group input-group-lg">
                                                                        <div class="form-floating">
                                                                            <input type="date" placeholder="" value="2024-12-25" required="" class="form-control border-start-0">
                                                            ...
                                                            <div class="col-1" style="width: 32%;">
                                                                <div  id="country-selector2" class="rounded border poste-chosen" style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;background-color: var(--adminux-theme-bg) !important;">
                                                                    <label style="margin-top: 5px;margin-left: 17px;color: #505050;font-size: 12px;margin-bottom: 6px;">Devise </label>
                                                                    <select class="chosenoptgroup w-100">
                                                                        <option value="Arabie" data-image="assets/img/drap/saudi-arabia.png">SAR</option>
                                                                        <option value="Belgique"  data-image="assets/img/drap/Belgique.jpg">EUR</option>
                                                                        <option value="Canada"  data-image="assets/img/drap/Canada.png">CAD</option>
                                                                        <option value="Cameroun"  data-image="assets/img/drap/cameroon.jpg">CFA</option>
                                                                        <option value="Chine"  data-image="assets/img/drap/china.jpg">CNY</option>
                                                                        <option value="Ivoire"  data-image="assets/img/drap/Cote_d'Ivoire.png">CFA</option>
                                                                        <option value="Espagne"  data-image="assets/img/drap/Spain.png">EUR</option>
                                                                        <option value="Unis"  data-image="assets/img/drap/united-arab-emirates.jpg">AED</option>
                                                                        <option value="France"  data-image="assets/img/drap/France.png">EUR</option>
                                                                        <option value="Inde"  data-image="assets/img/drap/india.jpg">INR</option>
                                                                        <option value="Irlande"  data-image="assets/img/drap/Ireland.png">EUR</option>
                                                                        <option value="Maroc" selected data-image="assets/img/drap/MAROC.jpg">MAD</option>
                                                                        <option value="Qatar"  data-image="assets/img/drap/QATAR.jpg">QAR</option>
                                                                        <option value="Sénégal"  data-image="assets/img/drap/senegal.jpg">CFA</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-2 ms-auto" style="width: 20%;height: 50px !important;margin-top: auto;margin-bottom: auto;">
                                                        <div class="row">
                                                            <div class="col-auto" data-bs-toggle="tooltip" data-bs-placement="top" title="Aperçu" style="margin-right: -15px;">
                                                                <div class="avatar avatar-50 rounded bg-light-theme">
                                                                    <a href="facture-apercu.html" target="_blank"><i class="bi bi-binoculars avatar   rounded h5"></i></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <table class="table table-shows all-client">
                                                            <thead style="font-size: 14px;">
                                                                <tr>
                                                                    <th colspan="4" style="text-align: center;border-top: 1px solid #c7c7c7">Client</th>
                                                                    <th rowspan="2" style="width: 2px;border: 0"></th>
                                                                    <th colspan="4" style="text-align: center;border-top: 1px solid #c7c7c7">FACTURE</th>
                                                                </tr>
                                                                <tr>
                                                                    <th style="width: 32px">
                                                                    ...
                                                                    <th style="width: 121px;text-align: right;">Montant</th>
                                                                    <th style="width: 234px;text-align: center;">Echéance</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody style="font-size: 14px">
                                                                <tr>
                                                                    ...
                                                                    <td>34211024</td>
                                                                    <td>VECTORIA LLC</td>
                                                                    <td rowspan="39" style="width: 2px;border: 0"></td>
                                                                    <td>FACA291/2024</td>
                                                                    <td>11/10/2024</td>
                                                                ...
                                                                <tr>
                                                                    <td style="border-bottom: 1px solid;"><input type="checkbox"></td>
                                                                    <td style="border-bottom: 1px solid;">27442</td>
                                                                    <td style="border-bottom: 1px solid;">34211008</td>
                                                                    <td style="border-bottom: 1px solid;">Arthur Benson</td>
                                                                    <td style="border-bottom: 1px solid;">FACA469/2024</td>
                                                                    <td style="border-bottom: 1px solid;">26/12/2024</td>
                                                                    <td style="border-bottom: 1px solid;text-align: right">5 000,00</td>
                                                                    <td style="border-bottom: 1px solid;text-align: center;">06/03/2025</td>
                                                                </tr>
                                                                <!------------------------>
                                                                <tr>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="font-weight: 700;border-bottom: 1px solid;">Total général</td>
                                                                    <td style="text-align: center;border-bottom: 1px solid;"></td>
                                                                    <td style="text-align: right;font-weight: 700;border-bottom: 1px solid;">197 500,00</td>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <table class="table table-shows client2 hidden">
                                                            ...
                                                            <tbody style="font-size: 14px">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;">FACA403/2024</td>
                                                                    <td style="border-bottom: 1px solid;">12/12/2024</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid;">5 000,00</td>
                                                                    <td style="text-align: center;border-bottom: 1px solid;">11/03/2025</td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;font-weight: 700">Total</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid;font-weight: 700">30 000,00</td>
                                                        ...
                                                        <table class="table table-shows client3 hidden">
                                                            ...
                                                            <tbody style="font-size: 14px">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;">Agricultura España</td>
                                                                    <td style="border-bottom: 1px solid;">FACA346/2024</td>
                                                                    <td style="border-bottom: 1px solid;">26/10/2024</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid;">5 000,00</td>
                                                                    <td style="border-bottom: 1px solid;text-align: center;">24/03/2025</td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;font-weight: 700">Total</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid;font-weight: 700">47 500,00</td>
                                                                    <td style="text-align: center;border-bottom: 1px solid;">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <table class="table table-shows client4 hidden">
                                                            ...
                                                            <tbody style="font-size: 14px">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;font-weight: 700">Total</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid;font-weight: 700">20 000,00</td>
                                                                    <td style="text-align: center;border-bottom: 1px solid;">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <table class="table table-shows client5 hidden">
                                                            ...
                                                            <tbody style="font-size: 14px">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;">Consortium Delta</td>
                                                                    <td style="border-bottom: 1px solid;">FACA450/2024</td>
                                                                    <td style="border-bottom: 1px solid;">23/12/2024</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid;">5 000,00</td>
                                                                    <td style="border-bottom: 1px solid;text-align: center;">15/04/2025</td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;font-weight: 700">Total</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid;font-weight: 700">75 000,00</td>
                                                                    <td style="text-align: center;border-bottom: 1px solid;">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <table class="table table-shows client6 hidden">
                                                            ...
                                                            <tr>
                                                                <th colspan="4" style="text-align: center;border-top: 1px solid #c7c7c7">Client</th>
                                                                <th rowspan="2" style="width: 2px;border: 0"></th>
                                                                <th colspan="5" style="text-align: center;border-top: 1px solid #c7c7c7">FACTURE</th>
                                                            </tr>
                                                            <tr>
                                                                <th style="width: 32px">
                                                                    <input type="checkbox">
                                                            ...
                                                            <tbody style="font-size: 14px">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;">VECTORIA LLC</td>
                                                                    <td style="border-bottom: 1px solid;">FACA460/2024</td>
                                                                    <td style="border-bottom: 1px solid;">23/12/2024</td>
                                                                    <td style="border-bottom: 1px solid;text-align: right">2 500,00</td>
                                                                    <td style="border-bottom: 1px solid;text-align: center;">11/04/2025</td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid;"></td>
                                                                    <td style="border-bottom: 1px solid;font-weight: 700">Total</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid;font-weight: 700">25 000,00</td>
                                                                    <td style="text-align: center;border-bottom: 1px solid;">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                ...
                                                <div class="row justify-content-center ">
                                                    <div class="col-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-1" style="width: 32%;">
                                                                <div  id="country-selector4" class="rounded border poste-chosen" style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;background-color: var(--adminux-theme-bg) !important;">
                                                                    <label style="margin-top: 5px;margin-left: 17px;color: #505050;font-size: 12px;margin-bottom: 6px;">Devise </label>
                                                                    <select class="chosenoptgroup w-100">
                                                                        <option value="Arabie" data-image="assets/img/drap/saudi-arabia.png">SAR</option>
                                                                        <option value="Belgique"  data-image="assets/img/drap/Belgique.jpg">EUR</option>
                                                    ...
                                                    <div class="col-2 ms-auto" style="width: 20%;height: 50px !important;margin-top: auto;margin-bottom: auto;">
                                                        <div class="row">
                                                            <div class="col-auto" data-bs-toggle="tooltip" data-bs-placement="top" title="Aperçu" style="margin-right: -15px;">
                                                                <div class="avatar avatar-50 rounded bg-light-theme">
                                                                    <a href="facture-gl-apercu.html" target="_blank"><i class="bi bi-binoculars avatar   rounded h5"></i></a>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto" data-bs-toggle="tooltip" data-bs-placement="top" title="Partager"  style="margin-right: -15px;">
                                                                <div class="avatar avatar-50 rounded bg-light-theme">
                                                ...
                                                <div class="row justify-content-center mb-3">
                                                    <div class="col-12 mb-4 show-gl-client gcl1">
                                                        <table class="table">
                                                            <thead style="font-size: 14px">
                                                                <tr style="border-top: 1px solid;">
                                                                    <th style="width: 233px;border-bottom: 1px solid;">N° client&nbsp;&nbsp;  27034</th>
                                                                    <th style="width: 261px;border-bottom: 1px solid;">Compte&nbsp;&nbsp;  34211021</th>
                                                                    <th style="border-bottom: 1px solid;">Client&nbsp;&nbsp;  AAT</th>
                                                                </tr>
                                                            </thead>
                                                        </table>
                                                        <table class="table" style="margin-top: 23px;">
                                                            ...
                                                            <tr>
                                                                <th rowspan="2" style="vertical-align: middle;width: 135px;">Date</th>
                                                                <th rowspan="2" style="vertical-align: middle;width: 305px;">Libellé</th>
                                                                <th rowspan="2" style="width: 2px;border: 0 !important;"></th>
                                                                <th colspan="2" style="text-align: center">Montant</th>
                                                                <th rowspan="2" style="width: 2px;border: 0 !important;"></th>
                                                                <th colspan="2" style="text-align: center">Solde</th>
                                                            </tr>
                                                            <tr>
                                                                <th style="text-align: center;width: 118px;">Débit</th>
                                                                <th style="text-align: left;width: 122px;">Crédit</th>
                                                                <th style="text-align: center;width: 122px;">Débit</th>
                                                                <th style="text-align: left;width: 122px;">Crédit</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            <tr>
                                                                ...
                                                                <td rowspan="29" style="width: 2px;border: 0 !important;"></td>
                                                                <td style="text-align: right;">15 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                   </td>
                                                                <td></td>
                                                                <td rowspan="29" style="width: 2px;border: 0 !important;"></td>
                                                                <td style="text-align: right">15 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td style="border-bottom: 1px solid #000">12/12/2024</td>
                                                                <td style="border-bottom: 1px solid #000">FACA403/2024 du 12/12/2024</td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">5 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">30 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="font-weight: 700;border-bottom: 1px solid #000">Total</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">30 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">30 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            </tr>
                                                    ...
                                                    <div class="col-12 mb-4 show-gl-client gcl2">
                                                        <table class="table">
                                                            <thead style="font-size: 14px">
                                                            <tr style="border-top: 1px solid;">
                                                                <th style="width: 233px;border-bottom: 1px solid;">N° client&nbsp;&nbsp;  27106</th>
                                                                <th style="width: 261px;border-bottom: 1px solid;">Compte&nbsp;&nbsp;  34211016</th>
                                                                <th style="border-bottom: 1px solid;">Client&nbsp;&nbsp;  Agricultura España</th>
                                                            </tr>
                                                            </thead>
                                                        </table>
                                                        <table class="table" style="margin-top: 23px;">
                                                            ...
                                                            <tr>
                                                                <th style="text-align: center;width: 118px;">Débit</th>
                                                                <th style="text-align: center;width: 122px;">Crédit</th>
                                                                <th style="text-align: center;width: 122px;">Débit</th>
                                                                <th style="text-align: left;width: 122px;">Crédit</th>
                                                            </tr>
                                                            </thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: right">5 000,00	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td></td>
                                                                <td style="text-align: right">47 500,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="border-bottom: 1px solid #000">23/12/2024</td>
                                                                <td style="border-bottom: 1px solid #000">Chèque n° ADE286114 - BMCE BANK</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">20 000,00	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">27 500,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="font-weight: 700;border-bottom: 1px solid #000">Total</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">47 500,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">20 000,00	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">27 500,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <div class="col-12 mb-4 show-gl-client gcl3">
                                                        <table class="table">
                                                            <thead style="font-size: 14px">
                                                            <tr style="border-top: 1px solid;">
                                                                <th style="width: 233px;border-bottom: 1px solid;">N° client&nbsp;&nbsp;  27442</th>
                                                                <th style="width: 261px;border-bottom: 1px solid;">Compte&nbsp;&nbsp;  34211008</th>
                                                                <th style="border-bottom: 1px solid;">Client&nbsp;&nbsp;  Arthur Benson</th>
                                                            </tr>
                                                            </thead>
                                                        </table>
                                                        <table class="table" style="margin-top: 23px;">
                                                            ...
                                                            <tr>
                                                                <td style="border-bottom: 1px solid #000">26/12/2024</td>
                                                                <td style="border-bottom: 1px solid #000">FACA469/2024 du 26/12/2024</td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">5 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">20 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-weight: 700;border-bottom: 1px solid #000">Total</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">20 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000"></td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">20 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            </tr>
                                                            </tbody>
                                                    ...
                                                    <div class="col-12 mb-4 show-gl-client gcl4">
                                                        <table class="table">
                                                            <thead style="font-size: 14px">
                                                            <tr style="border-top: 1px solid;">
                                                                <th style="width: 233px;border-bottom: 1px solid;">N° client&nbsp;&nbsp;  27056</th>
                                                                <th style="width: 261px;border-bottom: 1px solid;">Compte&nbsp;&nbsp;  34211012</th>
                                                                <th style="border-bottom: 1px solid;">Client&nbsp;&nbsp;  Consortium Delta</th>
                                                            </tr>
                                                            </thead>
                                                        </table>
                                                        <table class="table" style="margin-top: 23px;">
                                                            ...
                                                            <tr>
                                                                <td style="border-bottom: 1px solid #000">23/12/2024</td>
                                                                <td style="border-bottom: 1px solid #000">FACA450/2024 du 23/12/2024</td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">5 000,00	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">30 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            ...
                                                            <tr>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="font-weight: 700;border-bottom: 1px solid #000">Total</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">75 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">45 000,00	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">30 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            </tr>
                                                            </tbody>
                                                    ...
                                                    <div class="col-12 mb-4 show-gl-client gcl5">
                                                        <table class="table">
                                                            <thead style="font-size: 14px">
                                                            <tr style="border-top: 1px solid;">
                                                                <th style="width: 233px;border-bottom: 1px solid;">N° client&nbsp;&nbsp;  27100</th>
                                                                <th style="width: 261px;border-bottom: 1px solid;">Compte&nbsp;&nbsp;  34211024</th>
                                                                <th style="border-bottom: 1px solid;">Client&nbsp;&nbsp;  VECTORIA LLC</th>
                                                            </tr>
                                                            </thead>
                                                        </table>
                                                        <table class="table" style="margin-top: 23px;">
                                                            ...
                                                            <tr>
                                                                <td style="border-bottom: 1px solid #000">23/12/2024</td>
                                                                <td style="border-bottom: 1px solid #000">FACA460/2024 du 23/12/2024</td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">2 500,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="text-align: right;border-bottom: 1px solid #000">15 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                                <td style="font-weight: 700;border-bottom: 1px solid #000">Total</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">25 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">10 000,00	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="text-align: right;font-weight: 700;border-bottom: 1px solid #000">15 000,00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                <td style="border-bottom: 1px solid #000"></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                ...
                                                <div class="row justify-content-center ">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-auto" style="width: 32%">
                                                                <div class="form-group  position-relative check-valid is-valid">
                                                                    <div class="input-group input-group-lg">
                                                                        <div class="form-floating">
                                                                            <input type="date" placeholder="" value="2024-09-24" required="" class="form-control border-start-0">
                                                                            <label>Date début</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-auto" style="width: 32%">
                                                                <div class="form-group  position-relative check-valid is-valid">
                                                                    <div class="input-group input-group-lg">
                                                                        <div class="form-floating">
                                                                            <input type="date" placeholder="" value="2024-10-31" required="" class="form-control border-start-0">
                                                                            <label>Date fin</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-1" style="width: 32%;">
                                                                <div  id="country-selector3" class="rounded border poste-chosen" style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;background-color: var(--adminux-theme-bg) !important;">
                                                                    <label style="margin-top: 5px;margin-left: 17px;color: #505050;font-size: 12px;margin-bottom: 6px;">Devise </label>
                                                                    <select class="chosenoptgroup w-100">
                                                                        <option value="Arabie" data-image="assets/img/drap/saudi-arabia.png">SAR</option>
                                                                        <option value="Belgique"  data-image="assets/img/drap/Belgique.jpg">EUR</option>
                                                    ...
                                                    <div class="col-2 ms-auto" style="width: 20%;height: 50px !important;margin-top: auto;margin-bottom: auto;">
                                                        <div class="row">
                                                            <div class="col-auto" data-bs-toggle="tooltip" data-bs-placement="top" title="Aperçu" style="margin-right: -15px;">
                                                                <div class="avatar avatar-50 rounded bg-light-theme">
                                                                    <a href="facture-bal-apercu.html" target="_blank"><i class="bi bi-binoculars avatar   rounded h5"></i></a>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto" data-bs-toggle="tooltip" data-bs-placement="top" title="Partager"  style="margin-right: -15px;">
                                                                <div class="avatar avatar-50 rounded bg-light-theme">
                                                ...
                                                <div class="row justify-content-center mb-3">
                                                    <div class="col-12">
                                                        <table class="table">
                                                            <thead style="font-size: 14px">
                                                                <tr>
                                                                    <th rowspan="2" style="vertical-align: middle;border-top: 1px solid #c7c7c7">N° client</th>
                                                                    <th rowspan="2" style="vertical-align: middle;border-top: 1px solid #c7c7c7">Compte</th>
                                                                    <th rowspan="2" style="vertical-align: middle;border-top: 1px solid #c7c7c7">Raison sociale</th>
                                                                    <td rowspan="2" style="width: 2px;border: 0"></td>
                                                                    <th colspan="5" style="vertical-align: middle;text-align: center;border-top: 1px solid #c7c7c7">Echéance</th>
                                                                    <td rowspan="2" style="width: 2px;border: 0"></td>
                                                                    <th rowspan="2" style="vertical-align: middle;border-top: 1px solid #c7c7c7;text-align: right">Total</th>
                                                                </tr>
                                                                <tr  style="vertical-align: middle">
                                                                    <th style="text-align: right">De 1 à 30 Jours</th>
                                                                    <th style="text-align: right">De 31 à 45 Jours</th>
                                                                    <th style="text-align: right">De 46 à 60 Jours</th>
                                                                    <th style="text-align: right">De 61 à 90 Jours</th>
                                                                    <th style="text-align: right">Plus de 90 Jours</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody style="font-size: 14px">
                                                                <tr id="cl1" class="hg-tr">
                                                                    ...
                                                                    <td>34211021</td>
                                                                    <td>AAT</td>
                                                                    <td rowspan="29" style="width: 2px;border: 0"></td>
                                                                    <td style="text-align: right">15 000,00</td>
                                                                    <td style="text-align: right">10 000,00</td>
                                                                    <td style="text-align: right">5 000,00</td>
                                                                    ...
                                                                    <td style="text-align: right"></td>
                                                                    <td rowspan="29" style="width: 2px;border: 0"></td>
                                                                    <td style="font-weight: 700;text-align: right">30 000,00</td>
                                                                </tr>
                                                                <tr id="cl2" class="hg-tr">
                                                                    ...
                                                                    <td style="text-align: right">5 000,00</td>
                                                                    <td style="text-align: right"></td>
                                                                    <td style="font-weight: 700;text-align: right">27 500,00</td>
                                                                </tr>
                                                                <tr id="cl3" class="hg-tr">
                                                                    ...
                                                                    <td style="text-align: right"></td>
                                                                    <td style="text-align: right"></td>
                                                                    <td style="font-weight: 700;text-align: right">20 000,00</td>
                                                                </tr>
                                                                ...
                                                                <tr id="cl5" class="hg-tr">
                                                                    <td style="border-bottom: 1px solid #000">27100</td>
                                                                    <td style="border-bottom: 1px solid #000">34211024</td>
                                                                    <td style="border-bottom: 1px solid #000">VECTORIA LLC</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid #000">-10 000,00</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid #000">5 000,00</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid #000">5 000,00</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid #000">2 500,00</td>
                                                                    <td style="text-align: right;border-bottom: 1px solid #000">2 500,00</td>
                                                                    <td style="font-weight: 700;text-align: right;border-bottom: 1px solid #000">15 000,00</td>
                                                                </tr>
                                                                <tr id="cl6" class="hg-tr">
                                                                    <td colspan="3" style="font-weight: 700;text-align: center;border-bottom: 1px solid #000">Total</td>
                                                                    <td style="font-weight: 700;text-align: right;border-bottom: 1px solid #000">25 000,00</td>
                                                                    <td style="font-weight: 700;text-align: right;border-bottom: 1px solid #000">35 000,00</td>
                                                                    <td style="font-weight: 700;text-align: right;border-bottom: 1px solid #000">37 500,00</td>
                                                                    <td style="font-weight: 700;text-align: right;border-bottom: 1px solid #000">17 500,00</td>
                                                                    <td style="font-weight: 700;text-align: right;border-bottom: 1px solid #000">7 500,00</td>
                                                                    <td style="font-weight: 700;text-align: right;border-bottom: 1px solid #000">122 500,00</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <div class="row align-items-center mx-0 mt-4">
