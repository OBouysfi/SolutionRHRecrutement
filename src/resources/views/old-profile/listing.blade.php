                                    ...
                                    <div class="card border-0 p-0">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="table2 d-none alltable dataTable table-responsive" id="profile-2">
                                                <div class="row" style="padding-left: 13px;">
                                                    {{-- <h6 class="title custom-title">Profils actifs</h6> --}}
                                                    <div class="card-header bg-gradient-theme-light">
                                                        <div class="row align-items-center">
                                                            <h6 class="fw-medium mb-0">
                                                                {{ __('generated.Profils actifs') }}</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="table3 d-none alltable dataTable table-responsive" id="profile-3">
                                                <div class="row mb-4" style="padding-left: 13px;">
                                                    {{-- <h6 class="title custom-title">Profils qualifiés</h6> --}}
                                                    <div class="card-header bg-gradient-theme-light">
                                                        <div class="row align-items-center">
                                                            <h6 class="fw-medium mb-0">
                                                                {{ __('generated.Profils qualifiés') }}</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="table4 d-none alltable dataTable table-responsive" id="profile-4">
                                                <div class="row" style="padding-left: 13px;">
                                                    {{-- <h6 class="title custom-title">{{ __("generated.Profils pertinents") }}</h6> --}}
                                                    <div class="card-header bg-gradient-theme-light">
                                                        <div class="row align-items-center">
                                                            <h6 class="fw-medium mb-0">
                                                                {{ __('generated.Profils pertinents') }}</h6>
                                                        </div>
                                                    </div>
                                                </div>
