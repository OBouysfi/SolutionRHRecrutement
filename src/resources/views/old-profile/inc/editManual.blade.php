                    ...
                    <div class="row align-items-start justify-content-center mt-4 civillity-section"
                        ...
                        <div class="col-auto">
                            <div class="form-check form-check-circle">
                                ...
                                <label class="form-check-label translated_text" for="priceupgrade1">
                        ...
                        <div class="col-auto">
                            <div class="form-check form-check-circle">
                                <input class="form-check-input priceupgrade2" type="radio" name="civility_manual"
                                    ...
                                    @if (isset($profile) && $profile->civility != '1') checked @endif>
                                <label class="form-check-label translated_text" for="priceupgrade2">
