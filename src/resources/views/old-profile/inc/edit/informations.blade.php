                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-md-2 mb-2">
                                                            <div class="custom-multiple-select rounded border poste-chosen"
                                                                ...
                                                                <label><span >{{ __("generated.Civilité") }}</span>
                                                                    <span class="text-themeColor">*</span></label>
                                                                <select class="chosenoptgroup w-100" id="civility"
                                                                    name="civility" required>
                                                                    <option value="1" @if ($profile->civility == '1') selected @endif>
                                                                        {{ __("generated.M.") }}
                                                                    </option>
                                                                    <option value="2" @if ($profile->civility == '2') selected @endif>
                                                                        {{ __("generated.Mme") }}
                                                                    </option>
                                                                    <option value="3" @if ($profile->civility == '3') selected @endif>
                                                                        {{ __("generated.Mlle") }}
                                                                    </option>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div class="input-group input-group-lg">
                                                                    <div class="form-floating">
                                                                        ...
                                                                        <label for="birth_date">
                                                                            <span>{{ __("generated.Date de naissance") }}</span>
                                                                ...
                                                                <div class="input-group input-group-lg">
                                                                    <div class="form-floating">
                                                                        ...
                                                                        <label for="birth_place">
                                                                            <span>{{ __("generated.Lieu de naissance") }}</span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-12 col-md-3 mb-2">
                                                            <div class="custom-multiple-select rounded border poste-chosen"
                                                                ...
                                                                <label><span>{{ __("generated.Nationalité") }}</span>
                                                                    <span class="text-themeColor">*</span></label>
                                                                <select class="chosenoptgroup w-100"
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="input-group input-group-lg">
                                                                    <div class="form-floating">
                                                                        ...
                                                                        <label for="address">{{ __("generated.Adresse") }}</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @error('address')
                                                        ...
                                                        <div class="col-12 col-md-4 mb-2">
                                                            ...
                                                            <div class="custom-multiple-select rounded border poste-chosen Flag_Country"
                                                                style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;">
                                                                <label><span>{{ __("generated.Pays") }}</span>
                                                                    <span class="text-themeColor">*</span></label>
                                                                <select class="chosenoptgroup w-100" id="country-select"
                                                                    name="country_id">
                                                        ...
                                                        <div class="col-12 col-md-4 mb-2">
                                                            <div class="custom-multiple-select rounded border poste-chosen"
                                                                style="border-bottom: 1px solid var(--adminux-theme) !important;border-radius: 8px !important;">
                                                                <label><span>{{ __("generated.Ville") }}</span>
                                                                    <span class="text-themeColor">*</span></label>
                                                                ...
                                                                <div class="input-group input-group-lg">
                                                                    <div class="form-floating">
                                                                        ...
                                                                        <label for="phone_primary">
                                                                            <span>{{ __("generated.Téléphone 1") }}</span>
                                                                            <span class="text-themeColor">*</span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="input-group input-group-lg">
                                                                    <div class="form-floating">
                                                                        ...
                                                                        <label for="phone_secondary">
                                                                            <span>{{ __("generated.Téléphone 2") }}</span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                            ...
                                                                            <div class="row mt-4">
                                                                                <div class="col-12">
                                                                                    <button id="export-cv-button"
                                                                                        class="btn btn-theme btn-ajouter export-button translated_text"
                                                                                        type="button"
                                                                                        style="font-size: 12px; float: right; background-color: #26b6ea;"
                                                                                        data-file-name="{{ __($profile->last_name) }} {{ __($profile->first_name) }} cv"
                                                                                        data-file-url="{{ $profile->getCvUrl() }}">
                                                                                        {{ __("generated.Exporter CV") }}
                                                                                    </button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="file-upload">
                                                                                    ...
                                                                                    <label
                                                                                        ...
                                                                                        >{{ __("generated.Déposez la lettre de motivation ici ou cliquez pour le télécharger (PDF, DOC, DOCX - max 10 Mo)") }}</label>
                                                                            ...
                                                                            <div class="row mt-4">
                                                                                <div class="col-12">
                                                                                    <button id="export-cv-button"
                                                                                        ...
                                                                                        type="button"
                                                                                        style="font-size: 12px; float: right; background-color: #26b6ea;"
                                                                                        data-file-name="{{ __($profile->last_name) }} {{ __($profile->first_name) }} ettre de motivation"
                                                                                        data-file-url="{{ $profile->getCoverLetterUrl() }}">
                                                                                        {{ __("generated.Exporter la lettre de motivation") }}
                                                                                    </button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="file-upload">
                                                                                    <input type="file"
                                                                                        ...
                                                                                        accept="video/*">
                                                                                    <label 
                                                                                        for="file-input-video">{{ __("generated.Déposez la vidéo ici ou cliquez pour la télécharger (MP4, MOV, AVI, WMV - max 50 Mo)") }}</label>
                                                                            ...
                                                                            <div class="row mt-4">
                                                                                <div class="col-12">
                                                                                    <button id="export-cv-button"
                                                                                        ...
                                                                                        type="button"
                                                                                        style="font-size: 12px; float: right; background-color: #26b6ea;">{{ __("generated.Exporter Video") }}</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
