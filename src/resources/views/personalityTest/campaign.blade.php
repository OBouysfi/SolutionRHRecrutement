                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group mb-3 position-relative check-valid is-valid">
                                                    ...
                                                    <div class="input-group input-group-lg">
                                                        <div class="form-floating">
                                                            <input type="text" placeholder="{{ __("generated.Nom de la campagne") }}" value="" required="" class="form-control border-start-0 translated_text">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group mb-3 position-relative check-valid is-valid">
                                                    ...
                                                    <div class="input-group input-group-lg">
                                                        <div class="form-floating">
                                                            <input type="text" placeholder="{{ __("generated.Manager du poste") }}" value="" required="" class="form-control border-start-0 translated_text">
                                                            <label >{{ __("generated.Manager du poste") }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group mb-3 position-relative check-valid is-valid">
                                                    ...
                                                    <div class="input-group input-group-lg">
                                                        <div class="form-floating">
                                                            <input type="text" placeholder="{{ __("generated.Modèle prédictif") }}" value="" required="" class="form-control border-start-0 translated_text">
                                                            <label >{{ __("generated.Modèle prédictif") }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group mb-3 position-relative check-valid is-valid">
                                                    ...
                                                    <div class="input-group input-group-lg">
                                                        <div class="form-floating">
                                                            <input type="text" placeholder="{{ __("generated.Localisation") }}" value="" required="" class="form-control border-start-0 translated_text">
                                        ...
                                        <div class="row mb-1">
                                            <div class="col-12 ms-auto" style="width: 36%">
                                                <div class="form-check form-switch" style="margin-top: 4px;">
                                                    <button data-bs-toggle="modal" data-bs-target="#emailcompose" class="btn btn-theme mnw-100 bg-blue " style="float: right;font-size: 14px;margin-left: 10px">{{ __("generated.Enregistrer") }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
