<div class="chatboxes w-auto align-right bottom-0 mb-2 active show" id="chatModal">
            ...
            <div class="card shadow-none border-0">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <button type="button" class="btn   btn-outline-secondary border"><i
                ...
                <div class="card-body overflow-y-auto h-250 chat-list">
                    ...
                    <div class="row no-margin">
                        <div class="col-12 text-center">
                            <span class="alert-warning text-secondary mx-auto btn   py-1 mb-3">26 November
                                2021</span>
                        </div>
                    </div>
                    <div class="row no-margin left-chat">
                    ...
                    <div class="row no-margin">
                        <div class="col-12  text-center">
                            <span class="alert-warning text-secondary mx-auto btn   py-1 mb-3">25 November
                                2019</span>
                        </div>
                    </div>
                    <div class="row no-margin left-chat">
                    ...
                    <div class="row no-margin right-chat">
                        <div class="col-12">
                            <div class="chat-block">
                                <div class="row">
                                    <div class="col">
                                        <p>Ohh... Thats great. AdminUX is HTML template can be used in various business
                                            domains like
                ...
                <div class="card-footer p-0">
                    <div class="input-group input-group-md">
                        <button class="btn   btn-link px-2"><i class="bi bi-emoji-smile"></i></button>
                        <button class="btn   btn-link px-2"><i class="bi bi-paperclip"></i></button>
