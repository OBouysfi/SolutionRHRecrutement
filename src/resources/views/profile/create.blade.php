...
@section('title', __('generated.Ajouter un CV'))
...
title="{{ __("generated.Guide vidéo") }}">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-theme">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active translated_text" aria-current="page">{{ __("generated.Ajouter un CV")}}</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="container mt-4">
            ...
            <div class="row">
                ...
                @include('profile.inc.createManual')
                {{-- </div> --}}
            </div>
        </div>
    </main>
