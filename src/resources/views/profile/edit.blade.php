...
@section('title', __('generated.Modifié un CV'))
        ...
        <div class="container-fluid">
            <div class="row align-items-center page-title">
                <div class="col-12 col-md mb-2 mb-sm-0">
                    <h5 class="mb-0 translated_text">{{ __("generated.CVthèque")}}</h5>
                </div>
...
title="{{ __("generated.Guide vidéo") }}">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-theme">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active translated_text" aria-current="page">{{ __("generated.Modifier un CV")}}</li>
        ...
        <div class="container mt-4" >
                ...
                <div class="col-5">
                    <ul class="nav nav-tabs nav-adminux footer-tabs nav-fill" id="navtabscard30" role="tablist"
                        ...
                        <li class="nav-item d-flex justify-content-center translated_text" role="presentation">
                            <a class="nav-link active text-center" id="automatique-tab" data-bs-toggle="tab"
            ...
            <div class="row">
                ...
                {{-- @include('profile.inc.editAuto') --}}
                @include('profile.inc.editManual')
                {{-- </div> --}}
            </div>
        </div>
    </main>
