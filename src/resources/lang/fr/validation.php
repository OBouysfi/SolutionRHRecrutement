...
return [
    ...
    | la classe validateur. Certaines de ces règles ont plusieurs versions, comme les règles de taille. N'hésitez pas à modifier chacun de ces messages ici.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute fourni a été divulgué lors d\'une fuite de données. Veuillez choisir un :attribute différent.',
    ],
    ...
    */
    ...
    | par quelque chose de plus convivial pour le lecteur, comme "Adresse e-mail" au lieu de "email". Cela nous aide simplement à rendre nos messages plus expressifs.
    |
    */
