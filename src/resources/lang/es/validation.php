...
return [
    ...
    | la clase validador. Algunas de estas reglas tienen varias versiones, como las reglas de tamaño. No dude en modificar cada uno de estos mensajes aquí.
    |
    */
    ...
    'alpha_dash' => 'El campo :attribute solo puede contener letras, números, guiones y subrayados.',
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes de validación personalizados para atributos usando la convención "attribute.rule" para nombrar las líneas. Esto facilita la especificación de una línea de idioma personalizada específica para una regla de atributo determinada.
    |
    */
    ...
    | por algo más amigable para el lector, como "Dirección de correo electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer nuestro mensaje más expresivo.
    |
    */
