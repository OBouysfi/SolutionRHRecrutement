...
return [
    ...
    | classe validador. Algumas dessas regras têm várias versões, como as regras de tamanho. Sinta-se à vontade para ajustar cada uma dessas mensagens aqui.
    |
    */
    ...
    'ascii' => 'O campo :attribute só pode conter caracteres alfanuméricos de um byte e símbolos.',
    ...
    |--------------------------------------------------------------------------
    |
    | Você pode especificar aqui mensagens de validação personalizadas para atributos usando a convenção "attribute.rule" para nomear as linhas. Isso torna rápido especificar uma linha de idioma personalizada específica para uma regra de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de idioma a seguir são usadas para substituir nosso espaço reservado de atributo
